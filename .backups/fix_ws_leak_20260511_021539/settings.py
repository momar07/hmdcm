...
# Contexts considered as inbound (calls coming from outside).
# Override via env: ASTERISK_INBOUND_CONTEXTS=from-trunk,from-pstn-extra
import os as _os
ASTERISK_INBOUND_CONTEXTS = [
    c.strip() for c in _os.environ.get(
        'ASTERISK_INBOUND_CONTEXTS',
