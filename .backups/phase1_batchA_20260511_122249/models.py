...
class CallAgentEvent(BaseModel):
    ...
    EVENT_CHOICES = [
        ...
        ('popup_shown',     'Popup Shown to Agent'),
        ('answered',        'Call Answered'),
        ('rejected',        'Call Rejected'),
        ('dismissed',       'Popup Dismissed (X button)'),
        ('timeout',         'Ring Timeout'),
        ('taken_by_other',  'Taken by Another Agent'),
        ('ringhangup',      'Agent Hung Up While Ringing'),
        ('transfer_init',   'Transfer Initiated'),
        ('hold_started',    'Call Put On Hold'),
        ('hold_ended',      'Call Resumed from Hold'),
