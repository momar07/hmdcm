...
import { PRIORITY_LABELS, STATUS_LABELS } from "@/lib/helpers/tickets";
...
export function PriorityBadge({ priority }: { priority: TicketPriority }) {
  return (
    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${PRIORITY_COLORS[priority]}`}>
