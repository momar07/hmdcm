...
export const callsApi = {
  ...
  dismissCall: (callId: string) =>
    api.patch(`/calls/dismiss/${callId}/`),

  popupShown: (callId: string) =>
    api.post(`/calls/popup-shown/${callId}/`),

  agentActivity: (params?: { agent_id?: string; days?: number; event_type?: string; call_id?: string }) =>
    api.get(`/calls/agent-activity/`, { params }),
